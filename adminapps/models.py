...
class Lawyer_Data(models.Model):
    ...
    hourlyrate = models.DecimalField(max_digits = 7,decimal_places=2, blank=True, null=True)
...
class Client_Data(models.Model):
    ...
    industry = models.ForeignKey(NatureOfBusiness, on_delete=CASCADE, null=True)
...
class CaseFolder(models.Model):
    ...
    Supervisinglawyer = models.ForeignKey(Lawyer_Data, on_delete=CASCADE, null=True)
    remarks = models.TextField(blank=True, null=True)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class DueCode(models.Model):
    ...
    folder_type = models.ForeignKey(FolderType, on_delete=models.CASCADE, null=True, blank=True)
    apptype = models.ForeignKey(AppType, on_delete=models.CASCADE, null=True, blank=True)
    basisofcompute = models.CharField(max_length=15, choices = SelectBasis, null=True, blank=True)
    fieldbsis = models.CharField(max_length=30, choices = SelectFieldBasis, null=True, blank=True)
    terms = models.DecimalField(null=True, blank=True, max_digits=5, decimal_places=3)
...
class AppDueDate(models.Model):
    ...
    assignto = models.ForeignKey(Lawyer_Data, on_delete=models.CASCADE, null=True, blank=True)
...
class task_detail(models.Model):
    ...
    doc_type = models.CharField(max_length=20, choices=DOCTYPE, null=True, blank=True)
    task_code = models.ForeignKey(ActivityCodes, on_delete=models.CASCADE, blank=True, null=True)
    tran_type = models.CharField(max_length=15, choices=TRANTYPE, null=True, blank=True)
    preparedby = models.ForeignKey(User_Profile, on_delete=models.CASCADE, blank=True, null=True)
    lawyer = models.ForeignKey(Lawyer_Data, on_delete=models.CASCADE, null=True, blank=True)
    task = models.TextField(null=False, blank=False)
    spentinhrs = models.DecimalField(null=True, blank=True, max_digits=5, decimal_places=3)
    spentinmin = models.DecimalField(null=True, blank=True, max_digits=5, decimal_places=3)
    doc_date = models.DateField(null=True, blank=True)
    mailing_date = models.DateField(null=True, blank=True)
    examiner = models.ForeignKey(IPOExaminer, on_delete=models.PROTECT, null=True, blank=True)
    mail_type = models.CharField(max_length=15, choices=MAILTYPE, null=True, blank=True)
    contact_person = models.CharField(max_length=50, blank=True)
    duecode = models.ForeignKey(DueCode, on_delete=models.PROTECT, blank=True, null=True)
...
class MailsIn(models.Model):
    ...
    mailing_date = models.DateField(null=True, blank=True)
    examiner = models.ForeignKey(IPOExaminer, on_delete=models.PROTECT, null=True, blank=True)
    documentcode = models.ForeignKey(DocumentCode, on_delete=models.CASCADE, null=True, blank=True)
    mail_type = models.CharField(max_length=15, choices=MAILTYPE, null=True, blank=True)
    contact_person = models.CharField(max_length=50, blank=True)
...
class FilingDocs(models.Model):
    Task_Detail = models.ForeignKey(task_detail, on_delete=models.CASCADE, null=True)
...
class Alert_Messages(models.Model):
    messageto = models.ForeignKey(User, on_delete=PROTECT, null=True, blank=True)
...
class AccountsReceivable(models.Model):
    ...
    lawyer = models.ForeignKey(Lawyer_Data, on_delete=models.PROTECT, blank=True, null=True)
    ...
    payment_tag = models.CharField(max_length=5, choices=PAYMENTTAG, null=True, blank=True)
...
class Payments(models.Model):
    ...
    Charge_Amount = models.DecimalField(max_digits = 7,decimal_places=2, default=0)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class TempExpenses(models.Model):
    ...
    tran_date = models.DateField(null=True, blank=True)
    lawyer = models.ForeignKey(Lawyer_Data, on_delete=PROTECT, null=True, blank=True)
    expense_detail = models.CharField(max_length=250)
    expense_actual_amt = models.DecimalField(max_digits=7, decimal_places=2, default=0)
...
class TempBills(models.Model):
    ...
    matter = models.ForeignKey(Matters, on_delete=PROTECT, null=True)
    tran_date = models.DateField(null=True, blank=True)
    bill_service = models.ForeignKey(ActivityCodes, on_delete=PROTECT, null=True, blank=True)
    lawyer = models.ForeignKey(Lawyer_Data, on_delete=models.PROTECT, blank=True, null=True)
    particulars = models.TextField(max_length=250)
    spentinhrs = models.DecimalField(null=True, blank=True, max_digits=5, decimal_places=2)
    spentinmin = models.DecimalField(null=True, blank=True, max_digits=5, decimal_places=2)
    amount = models.DecimalField(max_digits = 7,decimal_places=2)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    prepared_by = models.CharField(max_length=60)
